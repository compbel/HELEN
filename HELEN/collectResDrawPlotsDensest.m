...
for c = 1:length(countriesAll)
    ...
    load(['HELEN data' filesep 'Densest subgraphs' filesep subgr_file]);
    ...
    for v = vocPredict
        for l = 1:length(predictLevels)
            ...
            if ~isempty(t)
                ...
                predictInterv1{l}(c,v) = -days(time_points(t)-tm1perc);
            end
        end
    end
...
%     exportgraphics(gca,['results' filesep 'figures' filesep countriesAll{c} '_densestFscore.png'],'Resolution',300)
end
...
% exportgraphics(fig,['results' filesep 'figures' filesep 'densestFscoreAll.png'],'Resolution',600)
...
% exportgraphics(gcf,['results' filesep 'figures' filesep 'densestSummary.png'],'Resolution',600)